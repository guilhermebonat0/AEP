    ...
    <div id="cadastro" className="cadastroLogin">
      ...
      <Formik
        ...
        validationSchema={object({
          cpf: string().required().min(10, "Mínimo de 11 dígitos").max(11, "Máximo de 11 dígitos"),
          email: string().required("Por favor digite o email").email("E-mail invalido"),
          cargo: string().required("Por favor digite o cargo").min(2, "Cargo muito curto"),
          nome: string().required("Por favor digite o nome").min(2, "Nome muito curto"),
          senha: string().required("Por favor digite a senha").min(6, "Senha de no mínimo 6 caracteres"),
        })}
